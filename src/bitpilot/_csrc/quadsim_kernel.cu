...
__global__ void render_cuda_kernel(
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> canvas,
    torch::PackedTensorAccessor64<scalar_t,4,torch::RestrictPtrTraits> flow,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> balls,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> cylinders,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> cylinders_h,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> voxels,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> R,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> R_old,
    torch::PackedTensorAccessor64<scalar_t,2,torch::RestrictPtrTraits> pos,
    torch::PackedTensorAccessor64<scalar_t,2,torch::RestrictPtrTraits> pos_old,
    float drone_radius,
...
__global__ void nearest_pt_cuda_kernel(
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> nearest_pt,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> balls,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> cylinders,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> cylinders_h,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> voxels,
    torch::PackedTensorAccessor64<scalar_t,3,torch::RestrictPtrTraits> pos,
    float drone_radius,
    int n_drones_per_group) {
...
__global__ void rerender_backward_cuda_kernel(
    torch::PackedTensorAccessor64<scalar_t,4,torch::RestrictPtrTraits> depth,
    torch::PackedTensorAccessor64<scalar_t,4,torch::RestrictPtrTraits> dddp,
    float fov_x_half_tan) {
...
void render_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES(canvas.scalar_type(), "render_cuda", ([&] {
        render_cuda_kernel<scalar_t><<<blocks, threads>>>(
            canvas.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            flow.packed_accessor64<scalar_t,4,torch::RestrictPtrTraits>(),
            balls.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            cylinders.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            cylinders_h.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            voxels.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            R.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            R_old.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            pos.packed_accessor64<scalar_t,2,torch::RestrictPtrTraits>(),
            pos_old.packed_accessor64<scalar_t,2,torch::RestrictPtrTraits>(),
            drone_radius,
            n_drones_per_group,
            fov_x_half_tan);
    }));
...
void rerender_backward_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES(depth.scalar_type(), "rerender_backward_cuda", ([&] {
        rerender_backward_cuda_kernel<scalar_t><<<blocks, threads>>>(
            depth.packed_accessor64<scalar_t,4,torch::RestrictPtrTraits>(),
            dddp.packed_accessor64<scalar_t,4,torch::RestrictPtrTraits>(),
            fov_x_half_tan);
    }));
}
...
void find_nearest_pt_cuda(
    ...
    AT_DISPATCH_FLOATING_TYPES(pos.scalar_type(), "nearest_pt_cuda", ([&] {
        nearest_pt_cuda_kernel<scalar_t><<<blocks, threads>>>(
            nearest_pt.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            balls.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            cylinders.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            cylinders_h.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            voxels.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            pos.packed_accessor64<scalar_t,3,torch::RestrictPtrTraits>(),
            drone_radius,
            n_drones_per_group);
    }));
}
